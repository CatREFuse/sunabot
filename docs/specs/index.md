...
日常导演由每个 Agent 的 `DIRECTOR_SEED.md`、公共“计划导演”与“演绎导演”提示词、SQLite 当日行程、`call_director` 和一次性主动分享任务共同组成；其消息、提示词、媒体、持久化、代码映射与验证边界分别记录在模块 02、03、04、06、07、08。

每日 Dream 由系统时区 04:00 调度、实际模型上下文召回统计、记忆整理、虚构梦境写回与审慎人格微调共同组成；其运行、提示词、记忆、管理台、持久化、代码映射与验证边界记录在模块 01 至 08。
