...
const downloaders = new Set(["bunx","corepack","npm","npx","pip","pip3","pnpm","uv","uvx","yarn"]);
const interpreters = new Set(["bash","dash","deno","env","fish","java","ksh","node","nodejs","perl","php","python","python3","ruby","sh","zsh"]);
