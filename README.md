...
当前版本：`0.2.0` · [更新日志](CHANGELOG.md) · [GitHub Releases](https://github.com/CatREFuse/sunabot/releases)
...
- 0.1.4 升级到 0.2.0：[跨平台 WebFetch Renderer 升级](docs/migrations/upgrade-0.1.4-to-0.2.0.md)
