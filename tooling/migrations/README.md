...
| `npm run upgrade:0.2.0 -- plan [--workspace PATH]` | 只读检查 0.1.4 到 0.2.0 的版本与 workspace |
| `npm run upgrade:0.2.0 -- apply [--workspace PATH]` | 自动停服、创建全 Agent SQLite 恢复点、启动并运行 status/doctor |
