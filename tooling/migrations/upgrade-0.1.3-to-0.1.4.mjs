...
export const FROM_VERSION = "0.1.3";
export const TARGET_VERSION = "0.1.4";
...
function usage() {
  return `用法：
  npm run upgrade:0.1.4 -- plan [--workspace /absolute/path]
  npm run upgrade:0.1.4 -- apply [--workspace /absolute/path]

plan 只读检查 0.1.4 代码与 workspace；apply 停服创建全 Agent SQLite 恢复点，
