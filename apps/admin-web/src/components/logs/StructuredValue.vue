...
.structured summary { display: grid; grid-template-columns: 16px minmax(112px, .55fr) minmax(0, 1.45fr); gap: 12px; align-items: start; min-height: 36px; padding: 8px 0; cursor: pointer; list-style: none; }
.structured summary::-webkit-details-marker { display: none; }
.structured summary:focus-visible { outline: 1px solid rgb(var(--color-interactive)); outline-offset: 2px; }
...
@media (max-width: 560px) {
  .structured summary { grid-template-columns: 16px minmax(0, 1fr); gap: 3px 8px; }
  .structured summary .structured__key,
  .structured summary .structured__count { grid-column: 2; }
