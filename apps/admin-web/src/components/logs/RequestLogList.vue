...
.request-list__marker { position: absolute; top: 20px; left: 0; z-index: 1; display: grid; width: 24px; height: 24px; place-items: center; transform: translateX(-40px); border: 1px solid rgb(var(--color-visible)); border-radius: 999px; background: rgb(var(--color-panel)); color: rgb(var(--color-mute)); font-size: 14px; }
...
@media (max-width: 560px) {
  ...
  .request-list__marker { width: 20px; height: 20px; transform: translateX(-32px); font-size: 12px; }
}
</style>
