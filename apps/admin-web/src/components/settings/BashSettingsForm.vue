...
<template>
  <section class="grid gap-8">
    <div>
      ...
      <p class="mt-2 text-sm text-mute">每条 Native 与 Docker Bash 命令均由独立审批 Agent 对抗审核。</p>
    </div>
    ...
    <div class="settings-group grid gap-5">
      ...
      <dl class="border-y border-line">
        ...
        <div class="divider-row">
          ...
          <dd class="inline-state"><i class="bx bx-folder mr-1" aria-hidden="true"></i>Native 与 Docker 分离</dd>
        </div>
        <div class="divider-row">
