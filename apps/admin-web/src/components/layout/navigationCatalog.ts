...
export const navigationSections: readonly NavigationSection[] = [
  {
    ...
    items: [
      ...
      { to: "/voice", label: "语音", mobileLabel: "语音", description: "语言与参考音频", icon: "bx-user-voice", mobilePlacement: "more", mobileOrder: 2 },
      { to: "/emojis", label: "表情", mobileLabel: "表情", description: "管理发送表情", icon: "bx-happy-alt", mobilePlacement: "more", mobileOrder: 3 },
      { to: "/logs", label: "日志", mobileLabel: "日志", description: "活动终端与请求日志", icon: "bx-terminal", mobilePlacement: "more", mobileOrder: 4 },
      { to: "/extensions", label: "扩展", mobileLabel: "扩展", description: "Skill 与 MCP", icon: "bx-extension", mobilePlacement: "more", mobileOrder: 5 }
    ]
  },
  {
    label: "公共系统",
