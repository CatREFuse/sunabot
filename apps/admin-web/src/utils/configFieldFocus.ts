const labels: Record<string, string> = {
  "server.host": "Host",
  "server.port": "Port",
  "persona.agentWorkspace": "Workspace",
  "persona.memoryLimit": "Memory Limit",
  ...
  "providers.items.*.temperature": "Temperature",
  "providers.items.*.maxOutputTokens": "Max Output Tokens",
  "bot.adminQq": "管理员 QQ",
  "bot.adminName": "管理员称呼",
  ...
  "onebot.reverseWsPath": "反向 WS Path",
  "onebot.accessTokenEnv": "Access Token Env",
