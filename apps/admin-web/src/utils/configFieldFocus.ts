const labels: Record<string, string> = {
  ...
  "bot.quoteGroupReplyExcludedUserIds.*": "过滤名单",
  "tone.enabled": "启用语气处理",
  "tone.segmentedReply": "分段回复",
  "tone.providerId": "Provider",
  "tone.model": "模型",
  "tone.reasoningEffort": "推理强度",
  "tone.temperature": "随机性（Temperature）",
  "tone.maxOutputTokens": "最大输出 Token",
  "tone.maxRetries": "失败重试次数",
  "memory.memoryModel": "模型",
  "memory.reasoningEffort": "推理强度",
  "memory.messageThreshold": "压缩阈值",
  "memory.workingMemoryMaxEntries": "工作记忆上限",
  "memory.dreamRecentWindowHours": "近期窗口（小时）",
  "memory.dreamRecentMemoryLimit": "24 小时记忆数",
  "memory.dreamOlderMemoryLimit": "久远记忆数",
